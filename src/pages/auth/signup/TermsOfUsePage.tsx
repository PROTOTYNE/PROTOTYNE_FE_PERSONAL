...
import { PAGE_URL, Plus, useLayoutStore } from "@/shared";
...
const  = () => {
  ...
  return (
    <Container>
      ...
      <br />
      회사는 시스템 정기점검, 불가항력 등의 사유로 서비스 제공을 일시적으로
      중단할 수 있습니다.
      <br />
      <br />
      ...
      <span>제10조 (손해배상)</span>
      <br />
      회사는 무료로 제공하는 서비스와 관련하여 회원에게 발생한 손해에 대해
      책임을 지지 않습니다. 다만, 회사의 고의 또는 중과실로 인한 손해는 예외로
      합니다.
      <br />
      <br />
      <span>제11조 (면책조항)</span>
      <br />
      회사는 천재지변 등 불가항력으로 인한 서비스 제공 불가 시 책임이
      면제됩니다.
      <br />
      <br />
